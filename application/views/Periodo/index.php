				...
				<section class="col-lg-12 connectedSortable">
					...
					<div class="nav-tabs-custom">
						...
						<ul class="nav nav-tabs pull-right">
							...
							<li class="pull-left header"><i class="fa fa-inbox"></i> Registro de Periodo Estudiantíl</li>
						</ul>
						<div class="tab-content no-padding">
                  <br />

                  <button class="btn btn-primary" onclick="add_periodo()"><i class="glyphicon glyphicon-plus"></i></button>
                  <br />
                  <br />
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h3 class="modal-title"> Registro de Periodos</h3>
                      </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-9">
                                <select class="form-control" name="name">
                                  <option value="Periodo1">1er Periodo</option>
                                  <option value="Periodo2">2do Periodo</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-md-9">
                                <input name="anio" placeholder="Digite Año del periodo" class="form-control" type="text">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-9">
                                <select class="form-control" name="estado">
                                  <option value="Abiero">Abierto</option>
