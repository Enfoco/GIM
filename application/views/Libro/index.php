<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="index2.html" class="logo">
			...
			<span class="logo-lg"><b>Gim</b>Master</span>
		</a>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown user user-menu">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="hidden-xs"><?= $this->session->userdata('perfil');?></span>
						</a>
						<ul class="dropdown-menu">
							<!-- User image -->
				...
				<section class="col-lg-12 connectedSortable">
					...
					<div class="nav-tabs-custom">
						...
						<ul class="nav nav-tabs pull-right">
							...
							<li class="pull-left header"><i class="fa fa-inbox"></i> Registro de Nuevo Libro</li>
						</ul>
						<div class="tab-content no-padding">


                  <br />
                <div class="alert alert-info" role="alert"><button class="btn btn-primary btn-xs" onclick="add_libro()"><i class="glyphicon glyphicon-plus"></i></button></div>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                ...
                                <h3 class="modal-title"> Registro Nuevo libro</h3>
                              </div>
                                ...
                                <form action="#" id="form" class="form-horizontal">
                                  ...
                                  <div class="form-body">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                        <input name="name" placeholder="Digite número de libro a registrar" class="form-control" type="text">
                                      </div>
                                    </div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('libro/ajax_list')?>",
            "type": "POST"
        },
    ...
    function add_libro()
    {
      ...
      $('.modal-title').text('Registro de libro'); // Set Title to Bootstrap modal title
    }

    function edit_libro(id)
    {
      save_method = 'update';
      $('#form')[0].reset(); // reset form on modals
      ...
      $.ajax({
        url : "<?php echo site_url('libro/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('libro/ajax_add')?>";
      }
      else
      {
        url = "<?php echo site_url('libro/ajax_update')?>";
      }
    ...
    function delete_libro(id)
    {
      if(confirm('Realmente Desea Borrar la información?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('libro/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
