				...
				<section class="col-lg-12 connectedSortable">
					...
					<div class="nav-tabs-custom">
						...
						<ul class="nav nav-tabs pull-right">
							...
							<li class="pull-left header"><i class="fa fa-inbox"></i> Registro de Nuevo Folio</li>
						</ul>
						<div class="tab-content no-padding">


                  <br />
                <div class="alert alert-info" role="alert"><button class="btn btn-primary btn-xs" onclick="add_folio()"><i class="glyphicon glyphicon-plus"></i></button></div>
