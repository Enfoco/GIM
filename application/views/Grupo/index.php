<div class="container">
    ...
    <br />
    <button class="btn btn-primary" onclick="add_grupo()"><i class="glyphicon glyphicon-plus"></i></button>
    <br />
    <br />
  ...
  <script type="text/javascript">
    ...
    function add_grupo()
    {
      ...
      $('.modal-title').text('Registro de grupo'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_grupo(id)
    {
      ...
      $.ajax({
        ...
        success: function(data)
        {
            ...
            $('.modal-title').text('Edit grupo'); // Set title to Bootstrap modal title
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title"> Registro Nuevo Grupo</h3>
      </div>
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="name" placeholder="Digite el nombre del grupo" class="form-control" type="text">
              </div>
            </div>
